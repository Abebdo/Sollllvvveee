  ...
  return (
    <div className={cn('w-full', className)} title={tooltipText}>
      <div className="flex justify-between items-end mb-2">
        <span className="text-xs font-medium text-slate-400 uppercase tracking-wider">Most Likely</span>
        <span className={cn(
            "font-bold font-mono", 
      ...
      <div className="h-2 w-full bg-slate-800 rounded-full overflow-hidden relative">
        ...
        />
        {/* Optional: Visual range indicator if desired, but using Tooltip as requested */}
      </div>
       {range && (
